...
$data = "SELECT * FROM vendor inner join vendor_tags ON vendor.Vendor_id = vendor_tags.Vendor_ID Where Tags = '$Tag'";

$resultN = mysqli_query($dbConnect, $data) 
